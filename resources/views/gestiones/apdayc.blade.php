    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="admin-card">
            <div class="border-b border-slate-100 pb-3 mb-4">
                ...
                <p class="text-[11px] text-slate-500 font-mono">SP: spGestionApdayc</p>
            </div>

            <form method="POST" action="{{ route('gestiones.generica.cargar', 'apdayc') }}" class="space-y-4">
                @csrf
        ...
        <div class="admin-card">
            <div class="flex items-center justify-between border-b border-slate-100 pb-3 mb-4">
                <div>
                    ...
                    <p class="text-[11px] text-slate-500 font-mono">Tabla: Gestiones_APDAYC</p>
                </div>
                <a href="{{ route('gestiones.manual.plantilla', 'apdayc') }}" class="btn-outline">
                    Descargar Estructura
                </a>
            </div>

            <form method="POST" action="{{ route('gestiones.manual.cargar', 'apdayc') }}" enctype="multipart/form-data" class="space-y-4">
                @csrf
                <div>
