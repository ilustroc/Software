    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div class="admin-card">
            <div class="flex items-center justify-between border-b border-slate-100 pb-3 mb-4">
                ...
                <a href="{{ route('gestiones.manual.plantilla', 'ivr') }}" class="btn-outline">
                    Descargar Estructura
                </a>
            </div>

            <form method="POST" action="{{ route('gestiones.manual.cargar', 'ivr') }}" enctype="multipart/form-data" class="space-y-4">
                @csrf
                <div>
