...
@section('title', 'Gestiones - Cartera Propia 4')
@section('page_title', 'Gestiones - Cartera Propia 4 (KPI)')
...
<div class="space-y-5">
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <div class="flex items-start justify-between gap-3">
                <div>
                    ...
                    <div class="mt-0.5 text-xs text-slate-500">
                        Ejecuta <span class="font-semibold text-slate-700">spGestionKpi(desde, hasta)</span>.
                    </div>
                </div>
            ...
            <form method="POST" action="{{ route('gestiones.propia4.cargar') }}" class="mt-4">
                @csrf
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <div class="flex items-start justify-between gap-3">
                <div>
                    ...
                    <div class="mt-0.5 text-xs text-slate-500">
                        Inserta en <span class="font-semibold text-slate-700">Gestiones_Propia4</span> respetando la plantilla.
                    </div>
                </div>

                <a href="{{ route('gestiones.propia4.plantillaSms') }}"
