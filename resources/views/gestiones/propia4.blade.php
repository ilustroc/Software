...
@section('content')
<h3>Gestiones - Cartera Propia 4 (KPI)</h3>
...
<div class="card border-0 shadow-sm mt-3">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('gestiones.propia4.cargar') }}" class="row g-3">
            @csrf

            <div class="col-md-3">
                <label class="form-label">Desde</label>
                <input type="date" name="desde"
                       value="{{ old('desde', date('Y-m-d')) }}"
