...
<div class="space-y-5">
    ...
    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a href="{{ route('pagos.propia3.template') }}"
    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
        ...
        <div class="lg:col-span-5 space-y-4">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <div class="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <div class="mt-0.5 text-xs text-slate-500">
                            Importa un archivo CSV/TXT para Cartera Propia 3 (delimitado por comas).
                        </div>
                    </div>
                ...
                <form method="POST" action="{{ route('pagos.propia3.upload') }}" enctype="multipart/form-data" class="mt-4 space-y-3">
                    @csrf
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                ...
                <form method="GET" action="{{ route('pagos.propia3.index') }}" class="mt-4 space-y-3">
                    <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        @if($dni)
                            <a
                                href="{{ route('pagos.propia3.index') }}"
        ...
        <div class="lg:col-span-7">
            <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                ...
                <form method="POST" action="{{ route('pagos.propia3.store') }}" class="mt-4">
                    @csrf
                        ...
                        <tr class="hover:bg-slate-50/60">
                            ...
                            <td class="px-4 py-3 text-center">
                                <div x-data="{ open:false }" class="inline-flex items-center gap-2">
                                    ...
                                    {{-- DELETE --}}
                                    <form method="POST"
                                          action="{{ route('pagos.propia3.destroy', $p->id) }}"
                                    ...
                                    <div x-show="open" x-transition.opacity style="display:none;"
                                        ...
                                        <div class="relative w-full max-w-lg rounded-2xl border border-slate-200 bg-white shadow-xl">
                                            ...
                                            <form method="POST" action="{{ route('pagos.propia3.update', $p->id) }}">
                                                @csrf
                                                @method('PUT')
