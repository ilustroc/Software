...
<div class="row g-4 mb-4 align-items-stretch">
    ...
    <div class="col-lg-5 d-flex flex-column gap-3">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="small text-muted">
                        Importa un archivo CSV/TXT con pagos de Cartera Propia 3.
                    </div>
                </div>
            ...
            <div class="card-body">
                <form method="POST"
                      action="{{ route('pagos.propia3.upload') }}"
        ...
        <div class="card border-0 shadow-sm mb-0">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('pagos.propia3.index') }}">
                    <div class="row g-3 align-items-end">
    ...
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('pagos.propia3.store') }}">
                    @csrf
                                ...
                                <div class="modal fade" id="modalPago{{ $p->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST"
                                                  action="{{ route('pagos.propia3.update', $p->id) }}">
                                                @csrf
                                                @method('PUT')
