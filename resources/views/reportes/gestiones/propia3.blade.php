...
@section('page_subtitle', 'Filtra por fecha, documento, teléfono y tipificación, y exporta a XLSX.')
...
<div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
  <form method="GET" action="{{ route('reportes.gestiones.propia3') }}" class="grid grid-cols-1 gap-3 md:grid-cols-12">
    ...
    <div class="md:col-span-12 flex flex-wrap gap-2 pt-1">
      ...
      <a href="{{ route('reportes.gestiones.propia3') }}"
         class="rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">
        Limpiar
      </a>

      <a href="{{ route('reportes.gestiones.propia3.xlsx', request()->query()) }}"
