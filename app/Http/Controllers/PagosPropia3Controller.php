...
class PagosPropia3Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = DB::table('Pagos_3')->orderBy('FECHA', 'desc');
        ...
        return view('pagos.propia3', compact('pagos', 'dni'));
    }
    ...
    public function template()
    {
        ...
        $headers = [
            ...
            'Content-Disposition' => 'attachment; filename="plantilla_pagos_3.csv"',
        ];
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            DB::table('Pagos_3')->where('id', $id)->update($data);
    ...
    public function destroy($id)
    {
        ...
        try {
            DB::table('Pagos_3')->where('id', $id)->where('SISTEMA', 3)->delete();
