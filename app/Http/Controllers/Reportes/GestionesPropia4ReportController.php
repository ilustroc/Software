...
use App\Exports\Gestiones\GestionesPropia4Export;
use Carbon\Carbon;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Maatwebsite\Excel\Facades\Excel;

class GestionesPropia4ReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('reportes.gestiones.propia4', compact(
    ...
    public function xlsx(Request $request)
    {
        ...
        $filename = "gestiones_propia4_{$desde}_{$hasta}.xlsx";

        return Excel::download(
            new GestionesPropia4Export($desde, $hasta, $telefono, $documento, $tipificacion),
            $filename
        );
    }
}
